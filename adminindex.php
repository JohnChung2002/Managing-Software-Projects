...
<nav class="navbar navbar-expand-lg" style="background-color: #1AA36D;">
    <div class="container-fluid mx-auto">
      <img src="images/cactus.png" class="me-4" height="90"
      alt="Cactus-Succlent Kuching Logo" loading="lazy" />
          ...
          <ul class="navbar-nav nav-pills nav-fill mb-4 mb-lg-0 ">
            ...
            <li class="nav-item">
              <a class="nav-link " href="#">
                <p class ="fs-5 mx-3 mt-3" style="color: white;">Report</p>
            </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">
                <p class ="fs-5 mx-3 mt-3" style="color: white;">Plant Encyclopedia</p>
            </a>
            </li>
