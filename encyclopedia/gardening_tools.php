...
if(isset($_GET['item_id'])){
	...
	$query = "SELECT * FROM encyclopedia_items WHERE (item_category='Tools & Accessories' OR item_category='Pesticides' OR item_category='Pots & Vases') AND item_id='$item_id'";
