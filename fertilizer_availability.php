...
<?php
	...
	$sql = "SELECT * FROM encyclopedia_items WHERE (item_category='Fertiliser' OR item_category='Compost & Soil') AND availability_in_store='Available'";
	...
	"<div class='col-md-4 mb-4'>
		<div class='card mb-4 shadow-sm h-100'>
			<div class='card-body' style='cursor: pointer;' onclick='window.location.href=\"fertilizer_availability.php\"'>
