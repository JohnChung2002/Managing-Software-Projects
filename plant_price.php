...
<button class="btn btn-dark" onclick="window.location.href='plant_encyclopedia.php'">All</button>
...
<?php
	...
	$sql = "SELECT * FROM encyclopedia_items WHERE (item_category='Plants' OR item_category='Seeds') AND price_in_store > 0 ORDER BY price_in_store ASC";
